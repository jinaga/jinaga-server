import { FactEnvelope, FactRecord, dehydrateFact } from "jinaga";
import { KeyPair } from "../../src/cryptography/KeyPair";
import { signFacts } from "../../src/cryptography/signFacts";
...
describe("signFacts", () => {
    it("should generate consistent signature", async () => {
        ...
        var factRecords: FactRecord[] = dehydrateFact({
            type: "MyApplication.Environment",
            identifier: "production"
        });
        var factEnvelopes: FactEnvelope[] = signFacts(keyPair, factRecords);
