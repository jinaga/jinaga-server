...
describe('Postgres', () => {
  ...
  it('should error on existential query on predecessor with no type', () => {
    ...
    expect(parse).toThrow(/Missing type of "Identifier.identified"/);
  });
